(defproject rainbow "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "rainbow.core/on-figwheel-reload"}

                :compiler {:main rainbow.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/rainbow.js"
